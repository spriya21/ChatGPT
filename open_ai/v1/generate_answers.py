...
df=pd.read_csv('./open_ai/v1/embeddings.csv', index_col=0)
...
# #df = df.head(10)
# questions['generated_response']=questions.Questions.apply(lambda x: answer_question(question=x));
