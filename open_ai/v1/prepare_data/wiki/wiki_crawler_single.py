...
with open('titles.txt', 'r') as f:
    # Read the contents of the file into a list of titles
    titles = f.readlines()
...
print(title_list)
pages = recursively_find_all_pages(title_list)
len(pages)
...
df.to_csv('fifa_wiki_sections_2.csv', index=False)


df1 = pd.read_csv('fifa_wiki_sections_2.csv')
df2 = pd.read_csv('fifa_wiki_sections.csv')

df3 = pd.concat([df1, df2])
df3 = df3.reset_index(drop=True)
df3 = df3.drop_duplicates(['title','heading'])

df3.to_csv('fifa_wiki_sections_merged.csv', index=False)
